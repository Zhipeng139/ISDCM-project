...
<div class="container">
    <div class="header">
        ...
        <div class="actions">
            <a class="button" href="<%= request.getContextPath() %>/busqueda">Buscar vídeo</a>
            <a class="button" href="<%= request.getContextPath() %>/registroVid">Nuevo vídeo</a>
    ...
    <div class="card">
        <table>
            <thead>
            <tr>
                <th>Título</th><th>Autor</th><th>Categoría</th><th>Resolución</th>
                <th>Formato</th><th>Fecha creación</th><th>Duración</th><th>Reproducciones</th><th></th>
            </tr>
            </thead>
            <tbody>
            <%
            ...
            <%  } } else if (videos != null) { %>
            <tr><td colspan="9" class="muted">No hay vídeos registrados.</td></tr>
            <% } %>
            </tbody>
        </table>
    </div>
