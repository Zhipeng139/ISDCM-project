...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .card { background: #fff; border-radius: 12px; box-shadow: 0 8px 20px rgba(0,0,0,0.08); padding: 20px; margin-bottom: 16px; }
        ...
        .play-btn { background: #74ebd5; color: #fff; border: none; border-radius: 6px; padding: 6px 12px; cursor: pointer; font-weight: 600; text-decoration: none; font-size: 13px; }
...
<div class="container">
    <div class="header">
        <h2>Cerca de vídeos</h2>
        <div style="display:flex;gap:10px;align-items:center;">
            <a class="button" href="<%= request.getContextPath() %>/listadoVid">Llistat complet</a>
    ...
    <div class="card" style="padding:0;overflow:auto;">
        <table>
            <thead>
            <tr><th>Títol</th><th>Autor</th><th>Data creació</th><th>Categoria</th><th>Duració</th><th>Reproduccions</th><th></th></tr>
            </thead>
            <tbody>
            <% if (videos.isEmpty()) { %>
            <tr><td colspan="7" class="muted">Cap vídeo trobat.</td></tr>
